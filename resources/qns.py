...
for concept in concepts:
    ...
    for row in problems_table.find_all("tr"):
        if row.find("i", {"class": "fa-lock"}) == None:
            ...
            difficulty = row.find(
                "td", {"label": "Difficulty"}).find("span").text
            title = problem['value']
